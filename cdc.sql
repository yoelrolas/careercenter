...
insert  into `userinformation`(`UserName`,`Email`,`CompanyID`,`Name`,`IdentityNo`,`BirthDate`,`ReligionID`,`Gender`,`Address`,`PhoneNumber`,`EducationID`,`UniversityName`,`FacultyName`,`MajorName`,`IsGraduated`,`GraduatedDate`,`YearOfExperience`,`RecentPosition`,`RecentSalary`,`ExpectedSalary`,`CVFilename`,`ImageFilename`,`RegisteredDate`) values ('admin','webmaster@cdc.del.ac.id',NULL,'Administrator',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),('admindel','info@del.ac.id',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),('operator','operator@dcc.sumutekno.com',NULL,'','','1970-01-01',0,1,'','',0,'','','',0,NULL,0,'',0,NULL,NULL,NULL,'2016-10-16'),('yoelrolas','rolassimanjuntak@gmail.com',NULL,'Yoel Rolas Simanjuntak','123456','1995-08-12',1,1,'Jl. Karya Gang. Adil No.16 Medan','123456',6,'Institut Teknologi Del','Teknik Elektro dan Informatika','Teknik Komputer',1,'2015-09-05',1,'Full Stack Web Developer',4000000,5000000,'CV-YoelRolasSimanjuntak.pdf','Pasfoto-3X4.jpg','2016-10-22');
...
insert  into `users`(`UserName`,`Password`,`RoleID`,`IsSuspend`,`LastLogin`,`LastLoginIP`) values ('admin','21232f297a57a5a743894a0e4a801fc3',1,0,'2016-10-22 21:36:17','::1'),('admindel','e10adc3949ba59abbe56e057f20f883e',2,0,'2016-10-22 21:28:36','::1'),('operator','bbfb3b97637d3caa18d4f73c6bf1b3b6',1,0,NULL,NULL),('yoelrolas','bbfb3b97637d3caa18d4f73c6bf1b3b6',3,0,NULL,NULL);
...
insert  into `vacancies`(`VacancyID`,`CompanyID`,`VacancyTypeID`,`PositionID`,`VacancyTitle`,`EndDate`,`VacancyEmail`,`VacancyDesc`,`VacancyResponsibility`,`VacancyRequirement`,`IsAllLocation`,`TotalView`,`CreatedBy`,`CreatedOn`,`UpdatedBy`,`UpdatedOn`,`IsSuspend`) values (1,1,1,2,'Programmer','2016-11-05','rolassimanjuntak@gmail.com','<p>TEST</p>\r\n','<p>TEST</p>\r\n','<p>TEST</p>\r\n',1,3,'admindel','2016-10-22 21:31:24','admindel','2016-10-22 21:31:24',0);
