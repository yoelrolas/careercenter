...
insert  into `companies`(`CompanyID`,`CompanyName`,`CompanyAddress`,`CompanyTelp`,`CompanyFax`,`CompanyWebsite`,`CompanyEmail`,`IndustryTypeID`,`CompanyDescription`,`RegisterDate`,`ApprovedDate`,`FileName`) values (1,'MANIK Corp','Jakarta','123456',NULL,NULL,NULL,2,NULL,'2016-11-07 09:39:47','2016-11-07 09:42:18','');
...
insert  into `userinformation`(`UserName`,`Email`,`CompanyID`,`Name`,`IdentityNo`,`BirthDate`,`ReligionID`,`Gender`,`Address`,`PhoneNumber`,`EducationID`,`UniversityName`,`FacultyName`,`MajorName`,`IsGraduated`,`GraduatedDate`,`YearOfExperience`,`RecentPosition`,`RecentSalary`,`ExpectedSalary`,`CVFilename`,`ImageFilename`,`RegisteredDate`) values ('admin','webmaster@cdc.del.ac.id',NULL,'Administrator',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),('manikcorp','hallo@manikcorp.org',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2016-11-07'),('operator','operator@dcc.sumutekno.com',NULL,'','','1970-01-01',0,1,'','',0,'','','',0,NULL,0,'',0,NULL,NULL,NULL,'2016-10-16'),('pelamar','rolassimanjuntak@gmail.com',NULL,'Pelamar','123456','2016-11-05',1,1,'Medan','123456',6,'ITDEL','Teknik Elektro dan Informatika','Teknik Komputer',1,'2015-09-05',1,'Full Stack Web Developer',4000000,NULL,NULL,NULL,'2016-11-07'),('pengangguran','yoelrolas@gmail.com',NULL,'Pengangguran','123456','1995-08-12',1,1,'Medan','123456',6,'Institut Teknologi Del','Teknik Elektro dan Informatika','Teknik Komputer',0,NULL,0,'',0,5000000,'data_d4_serdos_2015.pdf','17.jpg','2016-11-10');
...
insert  into `users`(`UserName`,`Password`,`RoleID`,`IsSuspend`,`LastLogin`,`LastLoginIP`) values ('admin','21232f297a57a5a743894a0e4a801fc3',1,0,'2016-11-10 02:21:26','::1'),('manikcorp','e10adc3949ba59abbe56e057f20f883e',2,0,'2016-11-10 21:41:24','::1'),('operator','bbfb3b97637d3caa18d4f73c6bf1b3b6',1,0,NULL,NULL),('pelamar','e10adc3949ba59abbe56e057f20f883e',3,0,'2016-11-09 21:25:17','::1'),('pengangguran','e10adc3949ba59abbe56e057f20f883e',3,0,'2016-11-10 22:07:38','::1');
...
insert  into `vacancies`(`VacancyID`,`CompanyID`,`VacancyTypeID`,`PositionID`,`VacancyTitle`,`EndDate`,`VacancyEmail`,`VacancyDesc`,`VacancyResponsibility`,`VacancyRequirement`,`IsAllLocation`,`OtherLocations`,`TotalView`,`CreatedBy`,`CreatedOn`,`UpdatedBy`,`UpdatedOn`,`IsSuspend`,`AttachmentFileName`) values (1,1,2,89,'Kuli Tambang','2016-11-23','hrd@manikcorp.org','<p>TEST</p>\r\n','<p>TEST</p>\r\n','<p>TEST</p>\r\n',0,'Porsea, Laguboti',23,'manikcorp','2016-11-07 09:45:56','admin','2016-11-07 09:47:40',0,'wilmar.pdf');
...
insert  into `vacancyapplies`(`VacancyApplyID`,`VacancyID`,`UserName`,`ApplyDate`,`StatusID`) values (1,1,'pelamar','2016-11-07 10:30:10',3);
...
insert  into `vacancyeducations`(`VacancyID`,`EducationTypeID`) values (1,6),(1,7);
...
insert  into `vacancylocations`(`VacancyID`,`LocationID`) values (1,1);
