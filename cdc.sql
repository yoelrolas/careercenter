...
insert  into `companies`(`CompanyID`,`CompanyName`,`CompanyAddress`,`CompanyTelp`,`CompanyFax`,`CompanyWebsite`,`CompanyEmail`,`IndustryTypeID`,`CompanyDescription`,`RegisterDate`,`ApprovedDate`,`FileName`) values (1,'Institut Teknologi Del','Jl. Sisingamangaraja, Sitoluama\r\nLaguboti, Toba Samosir\r\nSumatera Utara, Indonesia','+62 632 331234',NULL,NULL,NULL,19,NULL,'2016-11-13 16:36:14','2016-11-13 16:43:19','itdel1.jpg');
...
insert  into `userinformation`(`UserName`,`Email`,`CompanyID`,`Name`,`IdentityNo`,`BirthDate`,`ReligionID`,`Gender`,`Address`,`PhoneNumber`,`EducationID`,`UniversityName`,`FacultyName`,`MajorName`,`IsGraduated`,`GraduatedDate`,`YearOfExperience`,`RecentPosition`,`RecentSalary`,`ExpectedSalary`,`CVFilename`,`ImageFilename`,`RegisteredDate`) values ('admin','webmaster@cdc.del.ac.id',NULL,'Administrator',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),('admindel','rolassimanjuntak@gmail.com',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2016-11-13'),('operator','operator@dcc.sumutekno.com',NULL,'','','1970-01-01',0,1,'','',0,'','','',0,NULL,0,'',0,NULL,NULL,NULL,'2016-10-16'),('pelamar','yoelrolas@gmail.com',NULL,'Yoel Rolas Simanjuntak','123456','1995-08-12',1,1,'Medan','082380073802',6,'Institut Teknologi Del','Teknik Elektro dan Informatika','Teknik Komputer',1,'2015-09-05',1,'Full Stack Web Developer',4000000,NULL,NULL,NULL,'2016-11-13');
...
insert  into `users`(`UserName`,`Password`,`RoleID`,`IsSuspend`,`LastLogin`,`LastLoginIP`) values ('admin','21232f297a57a5a743894a0e4a801fc3',1,0,'2016-11-16 20:03:32','::1'),('admindel','e10adc3949ba59abbe56e057f20f883e',2,0,'2016-11-13 18:06:47','::1'),('operator','bbfb3b97637d3caa18d4f73c6bf1b3b6',1,0,NULL,NULL),('pelamar','e10adc3949ba59abbe56e057f20f883e',3,0,'2016-11-16 19:45:26','::1');
...
insert  into `vacancies`(`VacancyID`,`CompanyID`,`VacancyTypeID`,`PositionID`,`VacancyTitle`,`EndDate`,`VacancyEmail`,`VacancyDesc`,`VacancyResponsibility`,`VacancyRequirement`,`IsAllLocation`,`OtherLocations`,`TotalView`,`CreatedBy`,`CreatedOn`,`UpdatedBy`,`UpdatedOn`,`IsSuspend`,`AttachmentFileName`) values (1,1,4,22,'Programmer','2016-11-30','hrd@del.ac.id','<p>TEST</p>\r\n','<p>TEST</p>\r\n','<p>TEST</p>\r\n',0,'',1,'admindel','2016-11-13 16:58:17','admindel','2016-11-13 16:58:17',0,'');
...
insert  into `vacancyapplies`(`VacancyApplyID`,`VacancyID`,`UserName`,`ApplyDate`,`StatusID`) values (2,1,'pelamar','2016-11-13 18:06:07',1);
...
insert  into `vacancyeducations`(`VacancyID`,`EducationTypeID`) values (1,6),(1,7),(1,8);
...
insert  into `vacancylocations`(`VacancyID`,`LocationID`) values (1,4);
