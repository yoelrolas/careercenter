...
titleFontWeight:"normal",titleFontStyle:"normal",labelAngle:0,labelFontFamily:"arial",labelFontColor:"black",labelFontSize:12,labelFontWeight:"normal",labelFontStyle:"normal",prefix:"",suffix:"",includeZero:!0,tickLength:5,tickColor:"black",tickThickness:1,lineColor:"black",lineThickness:1,gridColor:"A0A0A0",gridThickness:0,interlacedColor:null,valueFormatString:null,margin:2},Legend:{name:null,borderThickness:0,borderColor:"black",cornerRadius:0,verticalAlign:"center",horizontalAlign:"right",fontSize:12,
fontFamily:"Calibri",fontWeight:"normal",fontColor:"black",fontStyle:"normal"},ToolTip:{enabled:!0,borderColor:null,shared:!1,animationEnabled:!0,content:null},TextBlock:{x:0,y:0,width:null,height:null,maxWidth:null,maxHeight:null,padding:0,angle:0,text:"",horizontalAlign:"center",fontSize:12,fontFamily:"Calibri",fontWeight:"normal",fontColor:"black",fontStyle:"normal",borderThickness:0,borderColor:"black",cornerRadius:0,backgroundColor:null,textBaseline:"top"}},S={colorSet1:"#369EAD #C24642 #7F6084 #86B402 #A2D1CF #C8B631 #6DBCEB #52514E #4F81BC #A064A1 #F79647".split(" "),
colorSet2:"#4F81BC #C0504E #9BBB58 #23BFAA #8064A1 #4AACC5 #F79647".split(" "),colorSet3:"#8CA1BC #36845C #017E82 #8CB9D0 #708C98 #94838D #F08891 #0366A7 #008276 #EE7757 #E5BA3A #F2990B #03557B #782970".split(" ")},U={theme1:{Chart:{colorSet:"colorSet1"},Title:{fontFamily:"Candara, Optima, Trebuchet MS, Helvetica Neue, Helvetica, Trebuchet MS, serif",fontSize:32,fontColor:"rgb(68,78,58)",fontColor:"#3A3A3A",fontWeight:"bold",verticalAlign:"top",margin:10},Axis:{titleFontSize:22,titleFontColor:"rgb(98,98,98)",
titleFontFamily:"Verdana, Geneva, Calibri, sans-serif",labelFontFamily:"Calibri, Optima, Candara, Verdana, Geneva, sans-serif",labelFontSize:18,labelFontColor:"grey",tickColor:"grey",tickThickness:2,gridThickness:2,gridColor:"grey",lineThickness:2,lineColor:"grey"},Legend:{verticalAlign:"bottom",horizontalAlign:"right",fontFamily:"monospace, sans-serif,arial black"},DataSeries:{bevelEnabled:!0,indexLabelFontColor:"grey",indexLabelFontFamily:"Candara, Optima, Calibri, Verdana, Geneva, sans-serif",
...
tickThickness:2,gridThickness:2,gridColor:"grey",lineThickness:0},Legend:{verticalAlign:"bottom",horizontalAlign:"right",fontFamily:"monospace, sans-serif,arial black"},DataSeries:{indexLabelFontColor:"grey",indexLabelFontFamily:"Courier New, Courier, monospace",indexLabelFontWeight:"bold",indexLabelFontSize:18,indexLabelLineColor:"lightgrey",indexLabelLineThickness:2}}},y={numberDuration:1,yearDuration:314496E5,monthDuration:2592E6,weekDuration:6048E5,dayDuration:864E5,hourDuration:36E5,minuteDuration:6E4,
...
break}c||(b={type:a.type,totalDataSeries:0,plotUnits:[]},this.plotInfo.plotTypes.push(b));for(g=0;g<b.plotUnits.length;g++)if(b.plotUnits[g].axisYType===a.axisYType){f=!0;e=b.plotUnits[g];break}f||(e={type:a.type,previousDataSeriesCount:0,index:b.plotUnits.length,plotType:b,axisYType:a.axisYType,axisY:"primary"===a.axisYType?this.axisY:this.axisY2,axisX:this.axisX,dataSeriesIndexes:[]},b.plotUnits.push(e));b.totalDataSeries++;e.dataSeriesIndexes.push(d)}for(d=0;d<this.plotInfo.plotTypes.length;d++){b=
this.plotInfo.plotTypes[d];for(g=a=0;g<b.plotUnits.length;g++)b.plotUnits[g].previousDataSeriesCount=a,a+=b.plotUnits[g].dataSeriesIndexes.length}};t.prototype.assignIdToDataPoints=function(){for(var a=0;a<this.data.length;a++){dataSeries=this.data[a];for(var d=dataSeries.dataPoints.length,b=0;b<d;b++)dataSeries.dataPointIds[b]=++this._eventManager.lastObjectId}};t.prototype._processData=function(){this.assignIdToDataPoints();this.categoriseDataSeries();for(var a=0;a<this.plotInfo.plotTypes.length;a++)for(var d=
...
this._options.axisX.maximum:Infinity;if(j.dataPoints[m].x&&j.dataPoints[m].x.getTime||"dateTime"===j.xValueType)f=!0;for(m=0;m<j.dataPoints.length;m++){"undefined"===typeof j.dataPoints[m].x&&(j.dataPoints[m].x=m);j.dataPoints[m].x.getTime?(f=!0,c=j.dataPoints[m].x.getTime()):c=j.dataPoints[m].x;e=j.dataPoints[m].y;c<b.min&&(b.min=c);c>b.max&&(b.max=c);if(0<m){var q=c-j.dataPoints[m-1].x;0>q&&(q*=-1);b.minDiff>q&&0!==q&&(b.minDiff=q)}if(!(c<l)||n){if(!n&&(n=!0,0<m)){m-=2;continue}if(c>s&&!p)p=!0;
else if(c>s&&p)continue;j.dataPoints[m].label&&(a.axisX.labels[c]=j.dataPoints[m].label);c<b.viewPortMin&&(b.viewPortMin=c);c>b.viewPortMax&&(b.viewPortMax=c);0<=e?g[c]=g[c]?g[c]+e:e:k[c]=k[c]?k[c]+e:e}}this.plotInfo.axisXValueType=j.xValueType=f?"dateTime":"number"}for(m in g)a=g[m],a<d.min&&(d.min=a),a>d.max&&(d.max=a),m<b.viewPortMin||m>b.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=a),a>d.viewPortMax&&(d.viewPortMax=a));for(m in k)a=k[m],a<d.min&&(d.min=a),a>d.max&&(d.max=a),m<b.viewPortMin||
m>b.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=a),a>d.viewPortMax&&(d.viewPortMax=a))}};t.prototype._processStacked100PlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)){for(var d=a.axisY.dataInfo,b=a.axisX.dataInfo,c,e,f=!1,g=!1,k=!1,h=[],j=0;j<a.dataSeriesIndexes.length;j++){var m=this.data[a.dataSeriesIndexes[j]],n=0,p=!1,l=!1;if("normal"===m.axisPlacement||"xySwapped"===m.axisPlacement)var s=this.sessionVariables.axisX.internalMinimum?this.sessionVariables.axisX.internalMinimum:
this._options.axisX&&this._options.axisX.minimum?this._options.axisX.minimum:-Infinity,q=this.sessionVariables.axisX.internalMaximum?this.sessionVariables.axisX.internalMaximum:this._options.axisX&&this._options.axisX.maximum?this._options.axisX.maximum:Infinity;if(m.dataPoints[n].x&&m.dataPoints[n].x.getTime||"dateTime"===m.xValueType)f=!0;for(n=0;n<m.dataPoints.length;n++){"undefined"===typeof m.dataPoints[n].x&&(m.dataPoints[n].x=n);m.dataPoints[n].x.getTime?(f=!0,c=m.dataPoints[n].x.getTime()):
c=m.dataPoints[n].x;e=m.dataPoints[n].y;c<b.min&&(b.min=c);c>b.max&&(b.max=c);if(0<n){var r=c-m.dataPoints[n-1].x;0>r&&(r*=-1);b.minDiff>r&&0!==r&&(b.minDiff=r)}if(!(c<s)||p){if(!p&&(p=!0,0<n)){n-=2;continue}if(c>q&&!l)l=!0;else if(c>q&&l)continue;m.dataPoints[n].label&&(a.axisX.labels[c]=m.dataPoints[n].label);c<b.viewPortMin&&(b.viewPortMin=c);c>b.viewPortMax&&(b.viewPortMax=c);0<=e?g=!0:k=!0;h[c]=h[c]?h[c]+Math.abs(e):Math.abs(e)}}this.plotInfo.axisXValueType=m.xValueType=f?"dateTime":"number"}g&&
!k?(d.max=99,d.min=1):g&&k?(d.max=99,d.min=-99):!g&&k&&(d.max=-1,d.min=-99);d.viewPortMin=d.min;d.viewPortMax=d.max;a.dataPointYSums=h}};t.prototype.getAutoFontSize=function(a){return Math.min(this.canvas.width,this.canvas.height)*(a/400)};t.prototype.resetOverlayedCanvas=function(){var a=this.overlaidCanvas.width;this.overlaidCanvas.width=0;this.overlaidCanvas.width=a};t.prototype.attachEvent=function(a){this._events.push(a)};t.prototype._touchEventHandler=function(a){if(a.changedTouches){var d=
[];first=(d=a.changedTouches)?d[0]:a;switch(a.type){case "touchstart":case "MSPointerDown":d=["mousemove","mousedown"];break;case "touchmove":case "MSPointerMove":d=["mousemove"];break;case "touchend":case "MSPointerUp":d="touchstart"===this._lastTouchEventType||"MSPointerDown"===this._lastTouchEventType?["mouseup","click"]:["mouseup"];break;default:return}this._lastTouchEventType=a.type;for(var b=0;b<d.length;b++){var c=d[b],e=document.createEvent("MouseEvent");e.initMouseEvent(c,!0,!0,window,1,
...
if(2<Math.abs(e)){if(this.panEnabled)e=!1,c=0,this.axisX.sessionVariables.internalMinimum<this.axisX._absoluteMinimum?(c=this.axisX._absoluteMinimum-this.axisX.sessionVariables.internalMinimum,this.axisX.sessionVariables.internalMinimum+=c,this.axisX.sessionVariables.internalMaximum+=c,e=!0):this.axisX.sessionVariables.internalMaximum>this.axisX._absoluteMaximum&&(c=this.axisX.sessionVariables.internalMaximum-this.axisX._absoluteMaximum,this.axisX.sessionVariables.internalMaximum-=c,this.axisX.sessionVariables.internalMinimum-=
c,e=!0),e&&this.render();else if(this.zoomEnabled){this.resetOverlayedCanvas();if(!this.dragStartPoint)return;"xySwapped"===this.plotInfo.axisPlacement?(b=Math.min(this.dragStartPoint.y,d),c=Math.max(this.dragStartPoint.y,d),1<Math.abs(b-c)&&(e=this.axisX.lineCoordinates,c=this.axisX.maximum-(this.axisX.maximum-this.axisX.minimum)/e.height*(c-e.y1),e=this.axisX.maximum-(this.axisX.maximum-this.axisX.minimum)/e.height*(b-e.y1),c=Math.max(c,this.axisX.dataInfo.min),e=Math.min(e,this.axisX.dataInfo.max),
Math.abs((e-c)/this.axisX.dataInfo.minDiff)>=0.008*this.canvas.height&&(this.axisX.sessionVariables.internalMinimum=c,this.axisX.sessionVariables.internalMaximum=e,this.render()))):"normal"===this.plotInfo.axisPlacement&&(c=Math.min(this.dragStartPoint.x,a),b=Math.max(this.dragStartPoint.x,a),1<Math.abs(c-b)&&(e=this.axisX.lineCoordinates,c=(this.axisX.maximum-this.axisX.minimum)/e.width*(c-e.x1)+this.axisX.minimum,e=(this.axisX.maximum-this.axisX.minimum)/e.width*(b-e.x1)+this.axisX.minimum,c=Math.max(c,
this.axisX.dataInfo.min),e=Math.min(e,this.axisX.dataInfo.max),Math.abs((e-c)/this.axisX.dataInfo.minDiff)>=0.01*this.canvas.width&&(this.axisX.sessionVariables.internalMinimum=c,this.axisX.sessionVariables.internalMaximum=e,this.render())))}this._toolBar.style.display="inline"}}this.dragStartPoint=null};t.prototype._plotAreaMouseMove=function(a,d){if(this.isDrag){var b=0,c=0,c=this.axisX.lineCoordinates;"xySwapped"===this.plotInfo.axisPlacement?(b=d-this.dragStartPoint.y,c=Math.abs(this.axisX.maximum-
...
this.overlaidCanvasCtx.fillRect(b.x1,this.dragStartPoint.y,b.x2-b.x1,d-this.dragStartPoint.y):"normal"===this.plotInfo.axisPlacement&&this.overlaidCanvasCtx.fillRect(this.dragStartPoint.x,b.y1,a-this.dragStartPoint.x,b.y2-b.y1),this.overlaidCanvasCtx.globalAlpha=c)}else this._toolTip.enabled&&this._toolTip.mouseMoveHandler(a,d)};t.prototype.getPlotArea=function(){var a,d,b,c;c=this.axisY?this.axisY:this.axisY2;if(this.axisX&&c)a=this.axisX.lineCoordinates.x1<this.axisX.lineCoordinates.x2?this.axisX.lineCoordinates.x1:
c.lineCoordinates.x1,b=this.axisX.lineCoordinates.y1<c.lineCoordinates.y1?this.axisX.lineCoordinates.y1:c.lineCoordinates.y1,d=this.axisX.lineCoordinates.x2>c.lineCoordinates.x2?this.axisX.lineCoordinates.x2:c.lineCoordinates.x2,c=this.axisX.lineCoordinates.y2>this.axisX.lineCoordinates.y1?this.axisX.lineCoordinates.y2:c.lineCoordinates.y2;else return this.layoutManager.getFreeSpace();return{x1:a,y1:b,x2:d,y2:c,width:d-a,height:c-b}};t.prototype.getPixelCoordinatesOnPlotArea=function(a,d){return{x:this.axisX.getPixelCoordinatesOnAxis(a).x,
y:this.axisY.getPixelCoordinatesOnAxis(d).y}};t.prototype.renderIndexLabels=function(){this.ctx.textBaseline="middle";for(var a=this.getPlotArea(),d=0;d<this._indexLabels.length;d++){var b=this._indexLabels[d],c,e,f;this.ctx.fillStyle="indexLabelFontColor"in b.dataPoint?b.dataPoint.indexLabelFontColor:b.dataSeries.indexLabelFontColor;f=this.ctx;var g=b.dataPoint,k=b.dataSeries,h="",h=h+(g.indexLabelFontStyle?g.indexLabelFontStyle+" ":k&&k.indexLabelFontStyle?k.indexLabelFontStyle+" ":""),h=h+(g.indexLabelFontWeight?
g.indexLabelFontWeight+" ":k&&k.indexLabelFontWeight?k.indexLabelFontWeight+" ":""),h=h+(g.indexLabelFontSize?g.indexLabelFontSize+"px ":k&&k.indexLabelFontSize?k.indexLabelFontSize+"px ":""),h=h+(g.indexLabelFontFamily?g.indexLabelFontFamily+" ":k&&k.indexLabelFontFamily?k.indexLabelFontFamily+" ":"");f.font=h;var g=this.replaceKeywordsWithValue("indexLabel"in b.dataPoint?b.dataPoint.indexLabel:b.dataSeries.indexLabel,b.dataPoint,b.dataSeries),k=this.ctx.measureText(g).width,h="indexLabelFontSize"in
b.dataPoint?b.dataPoint.indexLabelFontSize:b.dataSeries.indexLabelFontSize,j="indexLabelPlacement"in b.dataPoint?b.dataPoint.indexLabelPlacement:b.dataSeries.indexLabelPlacement,m="indexLabelOrientation"in b.dataPoint?b.dataPoint.indexLabelOrientation:b.dataSeries.indexLabelOrientation,n=f=0,p=0,l=0,s=0;"column"===b.chartType||"stackedColumn"===b.chartType||"stackedColumn100"===b.chartType||"bar"===b.chartType||"stackedBar"===b.chartType||"stackedBar100"===b.chartType?(Math.abs(b.bounds.x1,b.bounds.x2),
Math.abs(b.bounds.y1,b.bounds.y2),"normal"===this.plotInfo.axisPlacement?("outside"===j?(n=a.y1,p=a.y2):"inside"===j&&(n=b.bounds.y1,p=b.bounds.y2),"horizontal"===m?(c=b.point.x-k/2,e=0<=b.dataPoint.y?Math.min(Math.max(b.point.y-h/2-5,n+h/2+5),p-h/2-5):Math.max(Math.min(b.point.y+h/2+5,p-h/2),n+h/2+5)):"vertical"===m&&(c=b.point.x,e=0<=b.dataPoint.y?Math.min(Math.max(b.point.y-5,n+k+5),p):Math.max(Math.min(b.point.y+k+5,p-5),n),f=-90)):"xySwapped"===this.plotInfo.axisPlacement&&("outside"===j?(l=
a.x1,s=a.x2):"inside"===j&&(l=b.bounds.x1,s=b.bounds.x2),"horizontal"===m?(e=b.point.y,c=0<=b.dataPoint.y?Math.max(Math.min(b.point.x+5,s-k),l):Math.min(Math.max(b.point.x-k-5,l),s)):"vertical"===m&&(e=b.point.y+k/2,c=0<=b.dataPoint.y?Math.max(Math.min(b.point.x+h/2+5,s-h/2),l):Math.min(Math.max(b.point.x-h/2-5,l+h/2),s+h/2),f=-90))):"horizontal"===m?(c=b.point.x-k/2,e=0<=b.dataPoint.y?Math.max(b.point.y-h/2-5,a.y1+h/2):Math.min(b.point.y+h/2+5,a.y2-h/2)):"vertical"===m&&(c=b.point.x,e=0<=b.dataPoint.y?
Math.max(b.point.y-5,a.y1+k):Math.min(b.point.y+k+5,a.y2),f=-90);this.ctx.save();this.ctx.translate(c,e);this.ctx.rotate(Math.PI/180*f);this.ctx.fillText(g,0,0);this.ctx.restore()}};t.prototype.renderLine=function(a){if(!(0>=a.dataSeriesIndexes.length)){var d=this._eventManager.ghostCtx;this.ctx.save();var b=this.getPlotArea();this.ctx.beginPath();this.ctx.rect(b.x1,b.y1,b.width,b.height);this.ctx.clip();for(var b=[],c=0;c<a.dataSeriesIndexes.length;c++){var e=a.dataSeriesIndexes[c],f=this.data[e];
this.ctx.lineWidth=f.lineThickness;var g=f.dataPoints,k=f.id;this._eventManager.objectMap[k]={objectType:"dataSeries",dataSeriesIndex:e};k=A(k);d.strokeStyle=k;d.lineWidth=0<f.lineThickness?Math.max(f.lineThickness,4):0;colorSet=f._colorSet;color=colorSet[0];this.ctx.strokeStyle=color;var k=!0,h=0,j,m;if(0<g.length){for(h=0;h<g.length;h++)if(j=g[h].getTime?g[h].x.getTime():g[h].x,!(j<a.axisX.dataInfo.viewPortMin||j>a.axisX.dataInfo.viewPortMax)&&"number"===typeof g[h].y){j=a.axisX.convertionParameters.reference+
a.axisX.convertionParameters.pixelPerUnit*(j-a.axisX.convertionParameters.minimum)+0.5<<0;m=a.axisY.convertionParameters.reference+a.axisY.convertionParameters.pixelPerUnit*(g[h].y-a.axisY.convertionParameters.minimum)+0.5<<0;var n=f.dataPointIds[h];this._eventManager.objectMap[n]={objectType:"dataPoint",dataSeriesIndex:e,dataPointIndex:h,x1:j,y1:m};k?(this.ctx.beginPath(),this.ctx.moveTo(j,m),d.beginPath(),d.moveTo(j,m),k=!1):(this.ctx.lineTo(j,m),d.lineTo(j,m),0==h%500&&(this.ctx.stroke(),this.ctx.beginPath(),
this.ctx.moveTo(j,m),d.stroke(),d.beginPath(),d.moveTo(j,m)));if(0<g[h].markerSize||0<f.markerSize){var p=f.getMarkerProperties(h,j,m,this.ctx);b.push(p);n=A(n);b.push({x:j,y:m,ctx:d,type:p.type,size:p.size,color:n,borderColor:n,borderThickness:p.borderThickness})}(g[h].indexLabel||f.indexLabel)&&this._indexLabels.push({chartType:"line",dataPoint:g[h],dataSeries:f,point:{x:j,y:m},color:color})}this.ctx.stroke();d.stroke()}}H.drawMarkers(b);this.ctx.restore();this.ctx.beginPath();d.beginPath()}};var C=
...
a.beginPath(),a.moveTo(d,e),a.lineTo(d+m,e-m),a.lineTo(c-m,e-m),a.lineTo(c,e),a.closePath(),f=a.createLinearGradient((c+d)/2,e-m,(c+d)/2,e),f.addColorStop(0,color1),f.addColorStop(1,color2),a.fillStyle=f,a.fill(),a.restore());!0===h&&(a.save(),a.beginPath(),a.moveTo(d,b),a.lineTo(d+m,b+m),a.lineTo(d+m,e-m),a.lineTo(d,e),a.closePath(),f=a.createLinearGradient(d+m,(e+b)/2,d,(e+b)/2),f.addColorStop(0,color1),f.addColorStop(1,color3),a.fillStyle=f,a.fill(),a.restore());!0===j&&(a.save(),a.beginPath(),
a.moveTo(c,b),a.lineTo(c-m,b+m),a.lineTo(c-m,e-m),a.lineTo(c,e),f=a.createLinearGradient(c-m,(e+b)/2,c,(e+b)/2),f.addColorStop(0,color1),f.addColorStop(1,color3),a.fillStyle=f,f.addColorStop(0,color1),f.addColorStop(1,color3),a.fillStyle=f,a.fill(),a.closePath(),a.restore())};t.prototype.renderColumn=function(a){if(!(0>=a.dataSeriesIndexes.length)){var d=null,b=this.getPlotArea(),c=0,e,f,g=a.axisY.convertionParameters.reference+a.axisY.convertionParameters.pixelPerUnit*(0-a.axisY.convertionParameters.minimum)<<
0,k=0.15*this.canvas.width,c=a.axisX.dataInfo.minDiff,h=0.9*(b.width/Math.abs(a.axisX.maximum-a.axisX.minimum)*Math.abs(c)/a.plotType.totalDataSeries)<<0;this.ctx.save();this._eventManager.ghostCtx.save();this.ctx.beginPath();this.ctx.rect(b.x1,b.y1,b.width,b.height);this.ctx.clip();this._eventManager.ghostCtx.rect(b.x1,b.y1,b.width,b.height);this._eventManager.ghostCtx.clip();for(var j=0;j<a.dataSeriesIndexes.length;j++){var m=a.dataSeriesIndexes[j],n=this.data[m],p=n.dataPoints;1==p.length&&(h=
k);1>h?h=1:h>k&&(h=k);if(0<p.length)for(var l=5<h&&n.bevelEnabled?!0:!1,c=0;c<p.length;c++)if(p[c].getTime?f=p[c].x.getTime():f=p[c].x,!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax)&&"number"===typeof p[c].y){b=a.axisX.convertionParameters.reference+a.axisX.convertionParameters.pixelPerUnit*(f-a.axisX.convertionParameters.minimum)+0.5<<0;e=a.axisY.convertionParameters.reference+a.axisY.convertionParameters.pixelPerUnit*(p[c].y-a.axisY.convertionParameters.minimum)+0.5<<0;var s=
b-a.plotType.totalDataSeries*h/2+(a.previousDataSeriesCount+j)*h<<0,q=s+h<<0,r;0<=p[c].y?r=g:(r=e,e=g);e>r&&(r=e=r);d=p[c].color?p[c].color:n._colorSet[c%n._colorSet.length];C(this.ctx,s,e,q,r,d,l&&0<=p[c].y,0>p[c].y&&l,!1,!1);d=n.dataPointIds[c];this._eventManager.objectMap[d]={objectType:"dataPoint",dataSeriesIndex:m,dataPointIndex:c,x1:s,y1:e,x2:q,y2:r};d=A(d);C(this._eventManager.ghostCtx,s,e,q,r,d,!1,!1,!1,!1);if(p[c].indexLabel||n.indexLabel)this._indexLabels.push({chartType:"column",dataPoint:p[c],
dataSeries:n,point:{x:b,y:0<=p[c].y?e:r},bounds:{x1:s,y1:Math.min(e,r),x2:q,y2:Math.max(e,r)},color:d})}}this.ctx.restore();this._eventManager.ghostCtx.restore()}};t.prototype.renderStackedColumn=function(a){if(!(0>=a.dataSeriesIndexes.length)){var d=null,b=this.getPlotArea(),c=[],e=[],f=0,g,k=a.axisY.convertionParameters.reference+a.axisY.convertionParameters.pixelPerUnit*(0-a.axisY.convertionParameters.minimum)<<0,h=0.15*this.canvas.width,f=a.axisX.dataInfo.minDiff,j=0.9*(b.width/Math.abs(a.axisX.maximum-
a.axisX.minimum)*Math.abs(f)/a.plotType.plotUnits.length)<<0;this.ctx.save();this._eventManager.ghostCtx.save();this.ctx.beginPath();this.ctx.rect(b.x1,b.y1,b.width,b.height);this.ctx.clip();this._eventManager.ghostCtx.rect(b.x1,b.y1,b.width,b.height);this._eventManager.ghostCtx.clip();for(var m=0;m<a.dataSeriesIndexes.length;m++){var n=a.dataSeriesIndexes[m],p=this.data[n],l=p.dataPoints;1==l.length&&(j=h);1>j?j=1:j>h&&(j=h);if(0<l.length){var s=5<j&&p.bevelEnabled?!0:!1;this.ctx.strokeStyle="#4572A7 ";
for(f=0;f<l.length;f++)if(d=l[f].x.getTime?l[f].x.getTime():l[f].x,!(d<a.axisX.dataInfo.viewPortMin||d>a.axisX.dataInfo.viewPortMax)&&"number"===typeof l[f].y){b=a.axisX.convertionParameters.reference+a.axisX.convertionParameters.pixelPerUnit*(d-a.axisX.convertionParameters.minimum)+0.5<<0;g=a.axisY.convertionParameters.reference+a.axisY.convertionParameters.pixelPerUnit*(l[f].y-a.axisY.convertionParameters.minimum)+0.5<<0;var q=b-a.plotType.plotUnits.length*j/2+a.index*j<<0,r=q+j<<0,u;if(0<=l[f].y){var v=
c[d]?c[d]:0;g-=v;u=k-v;c[d]=v+(u-g)}else v=e[d]?e[d]:0,u=g+v,g=k+v,e[d]=v+(u-g);d=l[f].color?l[f].color:p._colorSet[f%p._colorSet.length];C(this.ctx,q,g,r,u,d,s&&0<=l[f].y,0>l[f].y&&s,!1,!1);d=p.dataPointIds[f];this._eventManager.objectMap[d]={objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:f,x1:q,y1:g,x2:r,y2:u};d=A(d);C(this._eventManager.ghostCtx,q,g,r,u,d,!1,!1,!1,!1);if(l[f].indexLabel||p.indexLabel)this._indexLabels.push({chartType:"stackedColumn",dataPoint:l[f],dataSeries:p,point:{x:b,
y:0<=l[f].y?g:u},bounds:{x1:q,y1:Math.min(g,u),x2:r,y2:Math.max(g,u)},color:d})}}}this.ctx.restore();this._eventManager.ghostCtx.restore()}};t.prototype.renderStackedColumn100=function(a){if(!(0>=a.dataSeriesIndexes.length)){var d=null,b=this.getPlotArea(),c=[],e=[],f=0,g,k=a.axisY.convertionParameters.reference+a.axisY.convertionParameters.pixelPerUnit*(0-a.axisY.convertionParameters.minimum)<<0,h=0.15*this.canvas.width,f=a.axisX.dataInfo.minDiff,j=0.9*(b.width/Math.abs(a.axisX.maximum-a.axisX.minimum)*
Math.abs(f)/a.plotType.plotUnits.length)<<0;this.ctx.save();this._eventManager.ghostCtx.save();this.ctx.beginPath();this.ctx.rect(b.x1,b.y1,b.width,b.height);this.ctx.clip();this._eventManager.ghostCtx.rect(b.x1,b.y1,b.width,b.height);this._eventManager.ghostCtx.clip();for(var m=0;m<a.dataSeriesIndexes.length;m++){var n=a.dataSeriesIndexes[m],p=this.data[n],l=p.dataPoints;1==l.length&&(j=h);1>j?j=1:j>h&&(j=h);if(0<l.length)for(var s=5<j&&p.bevelEnabled?!0:!1,f=0;f<l.length;f++)if(d=l[f].x.getTime?
l[f].x.getTime():l[f].x,!(d<a.axisX.dataInfo.viewPortMin||d>a.axisX.dataInfo.viewPortMax)&&"number"===typeof l[f].y){b=a.axisX.convertionParameters.reference+a.axisX.convertionParameters.pixelPerUnit*(d-a.axisX.convertionParameters.minimum)+0.5<<0;g=a.axisY.convertionParameters.reference+a.axisY.convertionParameters.pixelPerUnit*((0!==a.dataPointYSums[d]?100*(l[f].y/a.dataPointYSums[d]):0)-a.axisY.convertionParameters.minimum)+0.5<<0;var q=b-a.plotType.plotUnits.length*j/2+a.index*j<<0,r=q+j<<0,u;
if(0<=l[f].y){var v=c[d]?c[d]:0;g-=v;u=k-v;c[d]=v+(u-g)}else v=e[d]?e[d]:0,u=g+v,g=k+v,e[d]=v+(u-g);d=l[f].color?l[f].color:p._colorSet[f%p._colorSet.length];C(this.ctx,q,g,r,u,d,s&&0<=l[f].y,0>l[f].y&&s,!1,!1);d=p.dataPointIds[f];this._eventManager.objectMap[d]={objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:f,x1:q,y1:g,x2:r,y2:u};d=A(d);C(this._eventManager.ghostCtx,q,g,r,u,d,!1,!1,!1,!1);if(l[f].indexLabel||p.indexLabel)this._indexLabels.push({chartType:"stackedColumn100",dataPoint:l[f],
dataSeries:p,point:{x:b,y:0<=l[f].y?g:u},bounds:{x1:q,y1:Math.min(g,u),x2:r,y2:Math.max(g,u)},color:d})}}this.ctx.restore();this._eventManager.ghostCtx.restore()}};t.prototype.renderBar=function(a){if(!(0>=a.dataSeriesIndexes.length)){var d=null,b=this.getPlotArea(),c=0,e,f,g=a.axisY.convertionParameters.reference+a.axisY.convertionParameters.pixelPerUnit*(0-a.axisY.convertionParameters.minimum)<<0,k=0.15*this.canvas.height,c=a.axisX.dataInfo.minDiff,h=0.9*(b.height/Math.abs(a.axisX.maximum-a.axisX.minimum)*
Math.abs(c)/a.plotType.totalDataSeries)<<0;this.ctx.save();this._eventManager.ghostCtx.save();this.ctx.beginPath();this.ctx.rect(b.x1,b.y1,b.width,b.height);this.ctx.clip();this._eventManager.ghostCtx.rect(b.x1,b.y1,b.width,b.height);this._eventManager.ghostCtx.clip();for(var j=0;j<a.dataSeriesIndexes.length;j++){var m=a.dataSeriesIndexes[j],n=this.data[m],p=n.dataPoints;1==p.length&&(h=k);1>h?h=1:h>k&&(h=k);if(0<p.length){var l=5<h&&n.bevelEnabled?!0:!1;this.ctx.strokeStyle="#4572A7 ";for(c=0;c<
p.length;c++)if(p[c].getTime?f=p[c].x.getTime():f=p[c].x,!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax)&&"number"===typeof p[c].y){b=a.axisX.convertionParameters.reference+a.axisX.convertionParameters.pixelPerUnit*(f-a.axisX.convertionParameters.minimum)+0.5<<0;e=a.axisY.convertionParameters.reference+a.axisY.convertionParameters.pixelPerUnit*(p[c].y-a.axisY.convertionParameters.minimum)+0.5<<0;var s=b-a.plotType.totalDataSeries*h/2+(a.previousDataSeriesCount+j)*h<<0,q=s+h<<0,r;
0<=p[c].y?r=g:(r=e,e=g);d=p[c].color?p[c].color:n._colorSet[c%n._colorSet.length];C(this.ctx,r,s,e,q,d,l,!1,!1,!1);d=n.dataPointIds[c];this._eventManager.objectMap[d]={objectType:"dataPoint",dataSeriesIndex:m,dataPointIndex:c,x1:r,y1:s,x2:e,y2:q};d=A(d);C(this._eventManager.ghostCtx,r,s,e,q,d,!1,!1,!1,!1);this._indexLabels.push({chartType:"bar",dataPoint:p[c],dataSeries:n,point:{x:0<=p[c].y?e:r,y:b},bounds:{x1:Math.min(r,e),y1:s,x2:Math.max(r,e),y2:q},color:d})}}}this.ctx.restore();this._eventManager.ghostCtx.restore()}};
t.prototype.renderStackedBar=function(a){if(!(0>=a.dataSeriesIndexes.length)){var d=null,b=this.getPlotArea(),c=[],e=[],f=0,g,k=a.axisY.convertionParameters.reference+a.axisY.convertionParameters.pixelPerUnit*(0-a.axisY.convertionParameters.minimum)<<0,h=0.15*this.canvas.width,f=a.axisX.dataInfo.minDiff,j=0.9*(b.height/Math.abs(a.axisX.maximum-a.axisX.minimum)*Math.abs(f)/a.plotType.plotUnits.length)<<0;this.ctx.save();this._eventManager.ghostCtx.save();this.ctx.beginPath();this.ctx.rect(b.x1,b.y1,
b.width,b.height);this.ctx.clip();this._eventManager.ghostCtx.rect(b.x1,b.y1,b.width,b.height);this._eventManager.ghostCtx.clip();for(var m=0;m<a.dataSeriesIndexes.length;m++){var n=a.dataSeriesIndexes[m],p=this.data[n],l=p.dataPoints;1==l.length&&(j=h);1>j?j=1:j>h&&(j=h);if(0<l.length){var s=5<j&&p.bevelEnabled?!0:!1;this.ctx.strokeStyle="#4572A7 ";for(f=0;f<l.length;f++)if(d=l[f].x.getTime?l[f].x.getTime():l[f].x,!(d<a.axisX.dataInfo.viewPortMin||d>a.axisX.dataInfo.viewPortMax)&&"number"===typeof l[f].y){b=
a.axisX.convertionParameters.reference+a.axisX.convertionParameters.pixelPerUnit*(d-a.axisX.convertionParameters.minimum)+0.5<<0;g=a.axisY.convertionParameters.reference+a.axisY.convertionParameters.pixelPerUnit*(l[f].y-a.axisY.convertionParameters.minimum)+0.5<<0;var q=b-a.plotType.plotUnits.length*j/2+a.index*j<<0,r=q+j<<0,u;if(0<=l[f].y){var v=c[d]?c[d]:0;u=k+v;g+=v;c[d]=v+(g-u)}else v=e[d]?e[d]:0,u=g-v,g=k-v,e[d]=v+(g-u);d=l[f].color?l[f].color:p._colorSet[f%p._colorSet.length];C(this.ctx,u,q,
g,r,d,s,!1,!1,!1);d=p.dataPointIds[f];this._eventManager.objectMap[d]={objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:f,x1:u,y1:q,x2:g,y2:r};d=A(d);C(this._eventManager.ghostCtx,u,q,g,r,d,!1,!1,!1,!1);this._indexLabels.push({chartType:"stackedBar",dataPoint:l[f],dataSeries:p,point:{x:0<=l[f].y?g:u,y:b},bounds:{x1:Math.min(u,g),y1:q,x2:Math.max(u,g),y2:r},color:d})}}}this.ctx.restore();this._eventManager.ghostCtx.restore()}};t.prototype.renderStackedBar100=function(a){if(!(0>=a.dataSeriesIndexes.length)){var d=
null,b=this.getPlotArea(),c=[],e=[],f=0,g,k=a.axisY.convertionParameters.reference+a.axisY.convertionParameters.pixelPerUnit*(0-a.axisY.convertionParameters.minimum)<<0,h=0.15*this.canvas.width,f=a.axisX.dataInfo.minDiff,j=0.9*(b.height/Math.abs(a.axisX.maximum-a.axisX.minimum)*Math.abs(f)/a.plotType.plotUnits.length)<<0;this.ctx.save();this._eventManager.ghostCtx.save();this.ctx.beginPath();this.ctx.rect(b.x1,b.y1,b.width,b.height);this.ctx.clip();this._eventManager.ghostCtx.rect(b.x1,b.y1,b.width,
b.height);this._eventManager.ghostCtx.clip();for(var m=0;m<a.dataSeriesIndexes.length;m++){var n=a.dataSeriesIndexes[m],p=this.data[n],l=p.dataPoints;1==l.length&&(j=h);1>j?j=1:j>h&&(j=h);if(0<l.length){var s=5<j&&p.bevelEnabled?!0:!1;this.ctx.strokeStyle="#4572A7 ";for(f=0;f<l.length;f++)if(d=l[f].x.getTime?l[f].x.getTime():l[f].x,!(d<a.axisX.dataInfo.viewPortMin||d>a.axisX.dataInfo.viewPortMax)&&"number"===typeof l[f].y){b=a.axisX.convertionParameters.reference+a.axisX.convertionParameters.pixelPerUnit*
(d-a.axisX.convertionParameters.minimum)+0.5<<0;g=a.axisY.convertionParameters.reference+a.axisY.convertionParameters.pixelPerUnit*((0!==a.dataPointYSums[d]?100*(l[f].y/a.dataPointYSums[d]):0)-a.axisY.convertionParameters.minimum)+0.5<<0;var q=b-a.plotType.plotUnits.length*j/2+a.index*j<<0,r=q+j<<0,u;if(0<=l[f].y){var v=c[d]?c[d]:0;u=k+v;g+=v;c[d]=v+(g-u)}else v=e[d]?e[d]:0,u=g-v,g=k-v,e[d]=v+(g-u);d=l[f].color?l[f].color:p._colorSet[f%p._colorSet.length];C(this.ctx,u,q,g,r,d,s,!1,!1,!1);d=p.dataPointIds[f];
this._eventManager.objectMap[d]={objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:f,x1:u,y1:q,x2:g,y2:r};d=A(d);C(this._eventManager.ghostCtx,u,q,g,r,d,!1,!1,!1,!1);this._indexLabels.push({chartType:"stackedBar100",dataPoint:l[f],dataSeries:p,point:{x:0<=l[f].y?g:u,y:b},bounds:{x1:Math.min(u,g),y1:q,x2:Math.max(u,g),y2:r},color:d})}}}this.ctx.restore();this._eventManager.ghostCtx.restore()}};t.prototype.renderArea=function(a){if(!(0>=a.dataSeriesIndexes.length)){var d=this._eventManager.ghostCtx,
b=a.axisX.lineCoordinates,c=a.axisY.lineCoordinates,e=[],f=this.getPlotArea();this.ctx.save();d.save();this.ctx.beginPath();this.ctx.rect(f.x1,f.y1,f.width,f.height);this.ctx.clip();d.beginPath();d.rect(f.x1,f.y1,f.width,f.height);d.clip();for(f=0;f<a.dataSeriesIndexes.length;f++){var g=a.dataSeriesIndexes[f],k=this.data[g],h=k.dataPoints,e=k.id;this._eventManager.objectMap[e]={objectType:"dataSeries",dataSeriesIndex:g};e=A(e);d.fillStyle=e;var e=[],j=!0,m=0,n,p,l=a.axisY.convertionParameters.reference+
a.axisY.convertionParameters.pixelPerUnit*(0-a.axisY.convertionParameters.minimum)+0.5<<0,s,q=null;if(0<h.length){color=k._colorSet[m%k._colorSet.length];for(this.ctx.fillStyle=color;m<h.length;m++)if(p=h[m].x.getTime?h[m].x.getTime():h[m].x,!(p<a.axisX.dataInfo.viewPortMin||p>a.axisX.dataInfo.viewPortMax))if(n=a.axisX.convertionParameters.reference+a.axisX.convertionParameters.pixelPerUnit*(p-a.axisX.convertionParameters.minimum)+0.5<<0,p=a.axisY.convertionParameters.reference+a.axisY.convertionParameters.pixelPerUnit*
(h[m].y-a.axisY.convertionParameters.minimum)+0.5<<0,"number"===typeof h[m].y){j?(this.ctx.beginPath(),this.ctx.moveTo(n,p),q={x:n,y:p},d.beginPath(),d.moveTo(n,p),j=!1):(this.ctx.lineTo(n,p),d.lineTo(n,p),0==m%250&&(0>=a.axisY.minimum&&0<=a.axisY.maximum?s=l:0>a.axisY.maximum?s=c.y1:0<a.axisY.minimum&&(s=b.y2),this.ctx.lineTo(n,s),this.ctx.lineTo(q.x,s),this.ctx.closePath(),this.ctx.fill(),this.ctx.beginPath(),this.ctx.moveTo(n,p),d.lineTo(n,s),d.lineTo(q.x,s),d.closePath(),d.fill(),d.beginPath(),
d.moveTo(n,p),q={x:n,y:p}));var r=k.dataPointIds[m];this._eventManager.objectMap[r]={objectType:"dataPoint",dataSeriesIndex:g,dataPointIndex:m,x1:n,y1:p};if(0!==h[m].markerSize&&(0<h[m].markerSize||0<k.markerSize)){var u=k.getMarkerProperties(m,n,p,this.ctx);e.push(u);markerColor=A(r);e.push({x:n,y:p,ctx:d,type:u.type,size:u.size,color:markerColor,borderColor:markerColor,borderThickness:u.borderThickness})}(h[m].indexLabel||k.indexLabel)&&this._indexLabels.push({chartType:"area",dataPoint:h[m],dataSeries:k,
point:{x:n,y:p},color:color})}0>=a.axisY.minimum&&0<=a.axisY.maximum?s=l:0>a.axisY.maximum?s=c.y1:0<a.axisY.minimum&&(s=b.y2);this.ctx.lineTo(n,s);this.ctx.lineTo(q.x,s);this.ctx.closePath();this.ctx.fill();d.lineTo(n,s);d.lineTo(q.x,s);d.closePath();d.fill();H.drawMarkers(e)}}this.ctx.restore();this._eventManager.ghostCtx.restore()}};t.prototype.renderStackedArea=function(a){if(!(0>=a.dataSeriesIndexes.length)){var d=null,b=[],c=this.getPlotArea(),e=[],f=[],g=0,k,h,j,m=a.axisY.convertionParameters.reference+
a.axisY.convertionParameters.pixelPerUnit*(0-a.axisY.convertionParameters.minimum)<<0,n=this._eventManager.ghostCtx;n.beginPath();this.ctx.save();n.save();this.ctx.beginPath();this.ctx.rect(c.x1,c.y1,c.width,c.height);this.ctx.clip();n.beginPath();n.rect(c.x1,c.y1,c.width,c.height);n.clip();xValuePresent=[];for(c=0;c<a.dataSeriesIndexes.length;c++){var p=a.dataSeriesIndexes[c],l=this.data[p],s=l.dataPoints;l.dataPointIndexes=[];for(g=0;g<s.length;g++)p=s[g].x.getTime?s[g].x.getTime():s[g].x,l.dataPointIndexes[p]=
g,xValuePresent[p]||(f.push(p),xValuePresent[p]=!0);f.sort(Z)}for(c=0;c<a.dataSeriesIndexes.length;c++){var p=a.dataSeriesIndexes[c],l=this.data[p],s=l.dataPoints,q=!0,r=[],g=l.id;this._eventManager.objectMap[g]={objectType:"dataSeries",dataSeriesIndex:p};g=A(g);n.fillStyle=g;if(0<f.length){d=l._colorSet[0];this.ctx.fillStyle=d;for(g=0;g<f.length;g++){j=f[g];var u=null,u=0<=l.dataPointIndexes[j]?s[l.dataPointIndexes[j]]:{x:j,y:0};if(!(j<a.axisX.dataInfo.viewPortMin||j>a.axisX.dataInfo.viewPortMax)&&
"number"===typeof u.y){k=a.axisX.convertionParameters.reference+a.axisX.convertionParameters.pixelPerUnit*(j-a.axisX.convertionParameters.minimum)+0.5<<0;h=a.axisY.convertionParameters.reference+a.axisY.convertionParameters.pixelPerUnit*(u.y-a.axisY.convertionParameters.minimum)+0.5<<0;var v=e[j]?e[j]:0;h-=v;r.push({x:k,y:m-v});e[j]=m-h;if(q)this.ctx.beginPath(),this.ctx.moveTo(k,h),n.beginPath(),n.moveTo(k,h),q=!1;else if(this.ctx.lineTo(k,h),n.lineTo(k,h),0==g%250){for(;0<r.length;){var t=r.pop();
this.ctx.lineTo(t.x,t.y);n.lineTo(t.x,t.y)}this.ctx.closePath();this.ctx.fill();this.ctx.beginPath();this.ctx.moveTo(k,h);n.closePath();n.fill();n.beginPath();n.moveTo(k,h);r.push({x:k,y:m-v})}if(0<=l.dataPointIndexes[j]){var y=l.dataPointIds[l.dataPointIndexes[j]];this._eventManager.objectMap[y]={objectType:"dataPoint",dataSeriesIndex:p,dataPointIndex:l.dataPointIndexes[j],x1:k,y1:h}}if(0<=l.dataPointIndexes[j]&&0!==u.markerSize&&(0<u.markerSize||0<l.markerSize))j=l.getMarkerProperties(g,k,h,this.ctx),
b.push(j),markerColor=A(y),b.push({x:k,y:h,ctx:n,type:j.type,size:j.size,color:markerColor,borderColor:markerColor,borderThickness:j.borderThickness});(u.indexLabel||l.indexLabel)&&this._indexLabels.push({chartType:"stackedArea",dataPoint:u,dataSeries:l,point:{x:k,y:h},color:d})}}for(;0<r.length;)t=r.pop(),this.ctx.lineTo(t.x,t.y),n.lineTo(t.x,t.y);this.ctx.closePath();this.ctx.fill();this.ctx.beginPath();this.ctx.moveTo(k,h);n.closePath();n.fill();n.beginPath();n.moveTo(k,h)}delete l.dataPointIndexes}H.drawMarkers(b);
this.ctx.restore();n.restore()}};t.prototype.renderStackedArea100=function(a){if(!(0>=a.dataSeriesIndexes.length)){var d=null,b=this.getPlotArea(),c=[],e=[],f=[],g=0,k,h,j,m=a.axisY.convertionParameters.reference+a.axisY.convertionParameters.pixelPerUnit*(0-a.axisY.convertionParameters.minimum)<<0,n=0.15*this.canvas.width,p=a.axisX.dataInfo.minDiff,p=0.9*b.width/Math.abs(a.axisX.maximum-a.axisX.minimum)*Math.abs(p)<<0,l=this._eventManager.ghostCtx;this.ctx.save();l.save();this.ctx.beginPath();this.ctx.rect(b.x1,
...
u=!0,d=q.id;this._eventManager.objectMap[d]={objectType:"dataSeries",dataSeriesIndex:s};d=A(d);l.fillStyle=d;1==r.length&&(p=n);1>p?p=1:p>n&&(p=n);var v=[];if(0<f.length){d=q._colorSet[g%q._colorSet.length];this.ctx.fillStyle=d;for(g=0;g<f.length;g++){j=f[g];var t=null,t=0<=q.dataPointIndexes[j]?r[q.dataPointIndexes[j]]:{x:j,y:0};if(!(j<a.axisX.dataInfo.viewPortMin||j>a.axisX.dataInfo.viewPortMax)&&"number"===typeof t.y){h=0!==a.dataPointYSums[j]?100*(t.y/a.dataPointYSums[j]):0;k=a.axisX.convertionParameters.reference+
a.axisX.convertionParameters.pixelPerUnit*(j-a.axisX.convertionParameters.minimum)+0.5<<0;h=a.axisY.convertionParameters.reference+a.axisY.convertionParameters.pixelPerUnit*(h-a.axisY.convertionParameters.minimum)+0.5<<0;var y=e[j]?e[j]:0;h-=y;v.push({x:k,y:m-y});e[j]=m-h;if(u)this.ctx.beginPath(),this.ctx.moveTo(k,h),l.beginPath(),l.moveTo(k,h),u=!1;else if(this.ctx.lineTo(k,h),l.lineTo(k,h),0==g%250){for(;0<v.length;){var x=v.pop();this.ctx.lineTo(x.x,x.y);l.lineTo(x.x,x.y)}this.ctx.closePath();
this.ctx.fill();this.ctx.beginPath();this.ctx.moveTo(k,h);l.closePath();l.fill();l.beginPath();l.moveTo(k,h);v.push({x:k,y:m-y})}if(0<=q.dataPointIndexes[j]){var F=q.dataPointIds[q.dataPointIndexes[j]];this._eventManager.objectMap[F]={objectType:"dataPoint",dataSeriesIndex:s,dataPointIndex:q.dataPointIndexes[j],x1:k,y1:h}}if(0<=q.dataPointIndexes[j]&&0!==t.markerSize&&(0<t.markerSize||0<q.markerSize))j=q.getMarkerProperties(g,k,h,this.ctx),c.push(j),markerColor=A(F),c.push({x:k,y:h,ctx:l,type:j.type,
size:j.size,color:markerColor,borderColor:markerColor,borderThickness:j.borderThickness});(t.indexLabel||q.indexLabel)&&this._indexLabels.push({chartType:"stackedArea100",dataPoint:t,dataSeries:q,point:{x:k,y:h},color:d})}}for(;0<v.length;)x=v.pop(),this.ctx.lineTo(x.x,x.y),l.lineTo(x.x,x.y);this.ctx.closePath();this.ctx.fill();this.ctx.beginPath();this.ctx.moveTo(k,h);l.closePath();l.fill();l.beginPath();l.moveTo(k,h)}delete q.dataPointIndexes}H.drawMarkers(c);this.ctx.restore();l.restore()}};t.prototype.renderBubble=
function(a){var d=a.dataSeriesIndexes.length;if(!(0>=d)){var b=this.getPlotArea(),c=0,e,f,g=0.15*this.canvas.width,c=a.axisX.dataInfo.minDiff,d=0.9*(b.width/Math.abs(a.axisX.maximum-a.axisX.minimum)*Math.abs(c)/d)<<0;this.ctx.save();this._eventManager.ghostCtx.save();this.ctx.beginPath();this.ctx.rect(b.x1,b.y1,b.width,b.height);this.ctx.clip();this._eventManager.ghostCtx.rect(b.x1,b.y1,b.width,b.height);this._eventManager.ghostCtx.clip();for(var k=-Infinity,h=Infinity,j=0;j<a.dataSeriesIndexes.length;j++)for(var m=
a.dataSeriesIndexes[j],n=this.data[m],p=n.dataPoints,l=0,c=0;c<p.length;c++)if(e=p[c].getTime?e=p[c].x.getTime():e=p[c].x,!(e<a.axisX.dataInfo.viewPortMin||e>a.axisX.dataInfo.viewPortMax)&&"undefined"!==typeof p[c].z)l=p[c].z,l>k&&(k=l),l<h&&(h=l);for(var s=25*Math.PI,b=Math.max(Math.pow(0.25*Math.min(b.height,b.width)/2,2)*Math.PI,s),j=0;j<a.dataSeriesIndexes.length;j++)if(m=a.dataSeriesIndexes[j],n=this.data[m],p=n.dataPoints,1==p.length&&(d=g),1>d?d=1:d>g&&(d=g),0<p.length){this.ctx.strokeStyle=
"#4572A7 ";for(c=0;c<p.length;c++)if(e=p[c].getTime?e=p[c].x.getTime():e=p[c].x,!(e<a.axisX.dataInfo.viewPortMin||e>a.axisX.dataInfo.viewPortMax)&&"number"===typeof p[c].y){e=a.axisX.convertionParameters.reference+a.axisX.convertionParameters.pixelPerUnit*(e-a.axisX.convertionParameters.minimum)+0.5<<0;f=a.axisY.convertionParameters.reference+a.axisY.convertionParameters.pixelPerUnit*(p[c].y-a.axisY.convertionParameters.minimum)+0.5<<0;var l=p[c].z,q=2*Math.max(Math.sqrt((s+(b-s)/(k-h)*(l-h))/Math.PI)<<
0,1),l=n.getMarkerProperties(c,this.ctx);l.size=q;H.drawMarker(e,f,this.ctx,l.type,l.size,l.color,l.borderColor,l.borderThickness);var r=n.dataPointIds[c];this._eventManager.objectMap[r]={objectType:"dataPoint",dataSeriesIndex:m,dataPointIndex:c,x1:e,y1:f,size:q};q=A(r);H.drawMarker(e,f,this._eventManager.ghostCtx,l.type,l.size,q,q,l.borderThickness)}}this.ctx.restore();this._eventManager.ghostCtx.restore()}};t.prototype.renderScatter=function(a){var d=a.dataSeriesIndexes.length;if(!(0>=d)){var b=
this.getPlotArea(),c=0,e,f,g=0.15*this.canvas.width,c=a.axisX.dataInfo.minDiff,d=0.9*(b.width/Math.abs(a.axisX.maximum-a.axisX.minimum)*Math.abs(c)/d)<<0;this.ctx.save();this._eventManager.ghostCtx.save();this.ctx.beginPath();this.ctx.rect(b.x1,b.y1,b.width,b.height);this.ctx.clip();this._eventManager.ghostCtx.rect(b.x1,b.y1,b.width,b.height);this._eventManager.ghostCtx.clip();for(var k=0;k<a.dataSeriesIndexes.length;k++){var h=a.dataSeriesIndexes[k],j=this.data[h],m=j.dataPoints;1==m.length&&(d=
g);1>d?d=1:d>g&&(d=g);if(0<m.length){this.ctx.strokeStyle="#4572A7 ";Math.pow(0.3*Math.min(b.height,b.width)/2,2);for(var n=0,p=0,c=0;c<m.length;c++)if(e=m[c].getTime?e=m[c].x.getTime():e=m[c].x,!(e<a.axisX.dataInfo.viewPortMin||e>a.axisX.dataInfo.viewPortMax)&&"number"===typeof m[c].y){e=a.axisX.convertionParameters.reference+a.axisX.convertionParameters.pixelPerUnit*(e-a.axisX.convertionParameters.minimum)+0.5<<0;f=a.axisY.convertionParameters.reference+a.axisY.convertionParameters.pixelPerUnit*
(m[c].y-a.axisY.convertionParameters.minimum)+0.5<<0;var l=j.getMarkerProperties(c,e,f,this.ctx);H.drawMarker(l.x,l.y,l.ctx,l.type,l.size,l.color,l.color,l.thickness);Math.sqrt((n-e)*(n-e)+(p-f)*(p-f))<Math.min(l.size,5)||(n=j.dataPointIds[c],this._eventManager.objectMap[n]={objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:c,x1:e,y1:f},n=A(n),H.drawMarker(l.x,l.y,this._eventManager.ghostCtx,l.type,l.size,n,n,l.borderThickness),n=e,p=f)}}}this.ctx.restore();this._eventManager.ghostCtx.restore()}};
var L=function(a,d,b,c,e,f,g){a.save();"pie"===e?(a.beginPath(),a.moveTo(d.x,d.y),a.arc(d.x,d.y,b,f,g,!1),a.fillStyle=c,a.strokeStyle="white",a.lineWidth=2,a.closePath(),a.stroke(),a.fill()):"doughnut"===e&&(a.beginPath(),a.arc(d.x,d.y,b,f,g,!1),a.arc(d.x,d.y,0.6*b,g,f,!0),a.closePath(),a.fillStyle=c,a.strokeStyle="white",a.lineWidth=2,a.stroke(),a.fill());a.restore()};t.prototype.renderPie=function(a){function d(){w.ctx.save();w._eventManager.ghostCtx.save();w.ctx.translate(t.x,t.y);w._eventManager.ghostCtx.translate(t.x,
t.y);w.ctx.fillStyle=w.backgroundColor?w.backgroundColor:"white";w.ctx.fillRect(-v.width/2,-v.height/2,v.width,v.height);var a=!0===w.animationEnabled?60:1;if(null!=z&&z.frame<a){z.isAnimating--;for(var c=0,c=h[0],k=z.maxAngle+2*Math.PI/a,j=0;j<u;j++){var m=f.dataPoints[j].exploded,l=f.dataPoints[j].color?f.dataPoints[j].color:f.color?f.color:y[j%y.length],q=c,r=c=q+2*Math.PI/n*Math.abs(f.dataPoints[j].y),s=!1;r>k&&(r=k,s=!0);type=f.type;"outside"===f.indexLabelPlacement?(indexLineMinLength=Math.min(v.width,
v.height)/14,p=indexLineMinLength<x?x-indexLineMinLength:x-25):"inside"===f.indexLabelPlacement&&(p=(1-g)*0.5*Math.min(v.width,v.height));var B={x:0,y:0};L(w.ctx,B,p,l,type,q,r);q=!0===f.dataPoints[j].exploded?!0:!1;typeof f.dataPoints[j]===Boolean&&(userSetExploed=!0);r=f.dataPointIds[j];w._eventManager.objectMap[r]={objectType:"dataPoint",dataSeriesIndex:0,dataPointIndex:j,center:{x:t.x,y:t.y},radius:p,color:l,startAngle:h[j],endAngle:h[j+1],currentlyExploded:q,userSetExploded:m,pastExploded:!1};
m=T(r);w._eventManager.ghostCtx.save();l="rgb("+m[0]+","+m[1]+","+m[2]+")";L(w._eventManager.ghostCtx,B,p,l,type,h[j],h[j+1]);w._eventManager.ghostCtx.restore();if(s)break}z.maxAngle=k;z.frame++;z.frame<a?w.requestAnimFrame.call(window,d):(e(0,a),w.ctx.restore(),w._eventManager.ghostCtx.restore(),setTimeout(function(){z.frame=0;z.isAnimating=20;b()},200))}w.renderCount++;w.ctx.restore();w._eventManager.ghostCtx.restore()}function b(){w.ctx.save();w._eventManager.ghostCtx.save();w.ctx.translate(t.x,
t.y);w._eventManager.ghostCtx.translate(t.x,t.y);if(null!==z&&20>z.frame){z.isAnimating--;w.ctx.fillStyle=w.backgroundColor?w.backgroundColor:"white";w.ctx.fillRect(-v.width/2,-v.height/2,v.width,v.height);for(var a=0;a<u;a++){var c=f.dataPoints[a].color?f.dataPoints[a].color:f.color?f.color:y[a%y.length],d={x:0,y:0},k=p*g*Math.cos(j[a]),m=p*g*Math.sin(j[a]),l=f.type,n=f.dataPointIds[a],q=w._eventManager.objectMap[n].currentlyExploded,r=w._eventManager.objectMap[n].pastExploded;!0===q&&!1===r?(d.x+=
k/20*(z.frame+1),d.y+=m/20*(z.frame+1),20===z.frame+1&&(w._eventManager.objectMap[n].pastExploded=!0)):!0===q&&!0===r&&(d.x+=k,d.y+=m);w._eventManager.objectMap[n].center.x=d.x+t.x;w._eventManager.objectMap[n].center.y=d.y+t.y;r!==q&&(k={},k.dataSeries=f,k.dataPoint=f.dataPoints[a],k.index=a,w._toolTip.highlightObjects([k]));L(w.ctx,d,p,c,l,h[a],h[a+1]);19===z.frame&&(n=f.dataPointIds[a],c=T(n),w._eventManager.ghostCtx.save(),c="rgb("+c[0]+","+c[1]+","+c[2]+")",L(w._eventManager.ghostCtx,d,p,c,l,
h[a],h[a+1]),w._eventManager.ghostCtx.restore())}z.frame++;20>z.frame&&w.requestAnimFrame.call(window,b)}e(z.frame,20);w.ctx.restore();w._eventManager.ghostCtx.restore()}function c(){w.ctx.save();w._eventManager.ghostCtx.save();w.ctx.translate(t.x,t.y);w._eventManager.ghostCtx.translate(t.x,t.y);if(null!==z&&0<z.frame){z.isAnimating--;w.ctx.fillStyle=w.backgroundColor?w.backgroundColor:"white";w.ctx.fillRect(-v.width/2,-v.height/2,v.width,v.height);for(var a=0;a<u;a++){var b=f.dataPointIds[a],d=w._eventManager.objectMap[b].currentlyExploded,
k=w._eventManager.objectMap[b].pastExploded,m=f.dataPoints[a].color?f.dataPoints[a].color:f.color?f.color:y[a%y.length],l={x:0,y:0},n=f.type,d=w._eventManager.objectMap[b].currentlyExploded,q=p*g*Math.cos(j[a]),r=p*g*Math.sin(j[a]);!1===d&&!0===k?(l.x+=q/20*z.frame,l.y+=r/20*z.frame,1===z.frame&&(w._eventManager.objectMap[b].pastExploded=!1)):!0===d&&!0===k&&(l.x+=q,l.y+=r);w._eventManager.objectMap[b].center.x=l.x+t.x;w._eventManager.objectMap[b].center.y=l.y+t.y;k!==d&&(b={},b.dataSeries=f,b.dataPoint=
f.dataPoints[a],b.index=a,w._toolTip.highlightObjects([b]));L(w.ctx,l,p,m,n,h[a],h[a+1]);1===z.frame&&(b=f.dataPointIds[a],m=T(b),w._eventManager.ghostCtx.save(),m="rgb("+m[0]+","+m[1]+","+m[2]+")",L(w._eventManager.ghostCtx,l,p,m,n,h[a],h[a+1]),w._eventManager.ghostCtx.restore())}z.frame--;0<z.frame&&w.requestAnimFrame.call(window,c)}e(z.frame,20);w.ctx.restore();w._eventManager.ghostCtx.restore()}function e(a,b){for(var c=0;c<f.dataPoints.length;c++){var d=f.dataPointIds[c],e=w.ctx,h=l[c],n=s[c],
t=q[c],u=r[c],v=w._eventManager.objectMap[d].currentlyExploded,x=m[c],y=p,z=j[c],B=f.dataPoints[c].indexLabelFontColor?f.dataPoints[c].indexLabelFontColor:f.indexLabelFontColor,A=f.indexLabelPlacement,E=f.dataPoints[c].indexLabelLineColor?f.dataPoints[c].indexLabelLineColor:f.indexLabelLineColor,C=f.dataPoints[c].indexLabelLineThickness?f.dataPoints[c].indexLabelLineThickness:f.indexLabelLineThickness,D=a,F=b,d=w._eventManager.objectMap[d].pastExploded,G=k[c],H=f.dataPoints[c].indexLabelFontStyle?
f.dataPoints[c].indexLabelFontStyle:f.indexLabelFontStyle,I=f.dataPoints[c].indexLabelFontWeight?f.dataPoints[c].indexLabelFontWeight:f.indexLabelFontWeight,J=f.dataPoints[c].indexLabelFontSize?f.dataPoints[c].indexLabelFontSize:f.indexLabelFontSize,K=f.dataPoints[c].indexLabelFontFamily?f.dataPoints[c].indexLabelFontFamily:f.indexLabelFontFamily,L=f.dataPoints[c].indexLabelBackgroundColor?f.dataPoints[c].indexLabelBackgroundColor:f.indexLabelBackgroundColor?f.indexLabelBackgroundColor:null,M=c;e.save();
...
this.tickColor;for(e=0;e<this._labels.length;e++)f=this._labels[e],f.position<this.minimum||f.position>this.maximum||(d=this.getPixelCoordinatesOnAxis(f.position),this.tickThickness&&(this.ctx.beginPath(),this.ctx.moveTo(d.x<<0,d.y<<0),this.ctx.lineTo(d.x<<0,d.y-this.tickLength<<0),this.ctx.stroke()),a&&0!==c++%2||(0===f.textBlock.angle?(d.x-=f.textBlock.width/2,d.y-=this.tickLength+f.textBlock.height/2):(d.x-=0<this.labelAngle?f.textBlock.width*Math.cos(Math.PI/180*this.labelAngle):0,d.y-=this.tickLength+
...
this.ctx.stroke());else if(("left"===this._position||"right"===this._position)&&this.lineThickness)this.ctx.lineWidth=this.lineThickness,this.ctx.strokeStyle=this.lineColor,this.ctx.beginPath(),this.ctx.moveTo(this.lineCoordinates.x1,this.lineCoordinates.y1),this.ctx.lineTo(this.lineCoordinates.x2,this.lineCoordinates.y2),this.ctx.stroke()};x.prototype.getPixelCoordinatesOnAxis=function(a){var d={},b=this.lineCoordinates.width,c=this.lineCoordinates.height;if("bottom"===this._position||"top"===this._position)b/=
Math.abs(this.maximum-this.minimum),d.x=this.lineCoordinates.x1+b*(a-this.minimum),d.y=this.lineCoordinates.y1;if("left"===this._position||"right"===this._position)b=c/Math.abs(this.maximum-this.minimum),d.y=this.lineCoordinates.y2-b*(a-this.minimum),d.x=this.lineCoordinates.x2;return d};x.prototype.calculateValueToPixelConvertionParameters=function(){var a={pixelPerUnit:null,minimum:null,reference:null},d=this.lineCoordinates.width,b=this.lineCoordinates.height;a.minimum=this.minimum;if("bottom"===
this._position||"top"===this._position)a.pixelPerUnit=d/Math.abs(this.maximum-this.minimum),a.reference=this.lineCoordinates.x1;if("left"===this._position||"right"===this._position)a.pixelPerUnit=-1*b/Math.abs(this.maximum-this.minimum),a.reference=this.lineCoordinates.y2;this.convertionParameters=a};x.prototype.calculateAxisParameters=function(){var a=this.chart.layoutManager.getFreeSpace();"bottom"===this._position||"top"===this._position?(this.maxWidth=a.width,this.maxHeight=a.height):(this.maxWidth=
a.height,this.maxHeight=a.width);var a="axisX"===this.type?500>this.maxWidth?8:Math.max(6,Math.floor(this.maxWidth/62)):Math.floor(this.maxWidth/40),d,b,c,e;"axisX"===this.type?(d=null!==this.sessionVariables.internalMinimum?this.sessionVariables.internalMinimum:this.dataInfo.viewPortMin,b=null!==this.sessionVariables.internalMaximum?this.sessionVariables.internalMaximum:this.dataInfo.viewPortMax,0===b-d&&(b+=1),c=Infinity!==this.dataInfo.minDiff?this.dataInfo.minDiff:1):"axisY"===this.type&&(d="undefined"===
typeof this._options.minimum?this.dataInfo.viewPortMin:this._options.minimum,b="undefined"===typeof this._options.maximum?this.dataInfo.viewPortMax:this._options.maximum,0===b-d?(b+=5,d-=5):(0!==b&&(b+=Math.abs(0.05)),0!==d&&(d-=Math.abs(0.05))),this.includeZero&&"undefined"===typeof this._options.minimum&&0<d&&(d=0),this.includeZero&&"undefined"===typeof this._options.maximum&&0>b&&(b=0));"axisX"===this.type&&"dateTime"===this.chart.plotInfo.axisXValueType?(e=b-d,this.intervalType||(e/1<=a?(this.interval=
...
e/300<=a?(this.interval=300,this.intervalType="millisecond"):e/400<=a?(this.interval=400,this.intervalType="millisecond"):e/500<=a?(this.interval=500,this.intervalType="millisecond"):e/(1*y.secondDuration)<=a?(this.interval=1,this.intervalType="second"):e/(2*y.secondDuration)<=a?(this.interval=2,this.intervalType="second"):e/(5*y.secondDuration)<=a?(this.interval=5,this.intervalType="second"):e/(10*y.secondDuration)<=a?(this.interval=10,this.intervalType="second"):e/(15*y.secondDuration)<=a?(this.interval=
15,this.intervalType="second"):e/(20*y.secondDuration)<=a?(this.interval=20,this.intervalType="second"):e/(30*y.secondDuration)<=a?(this.interval=30,this.intervalType="second"):e/(1*y.minuteDuration)<=a?(this.interval=1,this.intervalType="minute"):e/(2*y.minuteDuration)<=a?(this.interval=2,this.intervalType="minute"):e/(5*y.minuteDuration)<=a?(this.interval=5,this.intervalType="minute"):e/(10*y.minuteDuration)<=a?(this.interval=10,this.intervalType="minute"):e/(15*y.minuteDuration)<=a?(this.interval=
15,this.intervalType="minute"):e/(20*y.minuteDuration)<=a?(this.interval=20,this.intervalType="minute"):e/(30*y.minuteDuration)<=a?(this.interval=30,this.intervalType="minute"):e/(1*y.hourDuration)<=a?(this.interval=1,this.intervalType="hour"):e/(2*y.hourDuration)<=a?(this.interval=2,this.intervalType="hour"):e/(3*y.hourDuration)<=a?(this.interval=3,this.intervalType="hour"):e/(6*y.hourDuration)<=a?(this.interval=6,this.intervalType="hour"):e/(1*y.dayDuration)<=a?(this.interval=1,this.intervalType=
"day"):e/(2*y.dayDuration)<=a?(this.interval=2,this.intervalType="day"):e/(4*y.dayDuration)<=a?(this.interval=4,this.intervalType="day"):e/(1*y.weekDuration)<=a?(this.interval=1,this.intervalType="week"):e/(2*y.weekDuration)<=a?(this.interval=2,this.intervalType="week"):e/(3*y.weekDuration)<=a?(this.interval=3,this.intervalType="week"):e/(1*y.monthDuration)<=a?(this.interval=1,this.intervalType="month"):e/(2*y.monthDuration)<=a?(this.interval=2,this.intervalType="month"):e/(3*y.monthDuration)<=a?
(this.interval=3,this.intervalType="month"):e/(6*y.monthDuration)<=a?(this.interval=6,this.intervalType="month"):(this.interval=e/(1*y.yearDuration)<=a?1:e/(2*y.yearDuration)<=a?2:e/(4*y.yearDuration)<=a?4:Math.floor(x.getNiceNumber(e/(a-1),!0)/y.yearDuration),this.intervalType="year")),this.minimum=null!==this.sessionVariables.internalMinimum?this.sessionVariables.internalMinimum:d-c/2,this.maximum=this.sessionVariables.internalMaximum?this.sessionVariables.internalMaximum:b+c/2,this.valueFormatString||
...
this.intervalStartPosition=this.getLabelStartPoint(new Date(this.minimum),this.intervalType,this.interval)):(this.intervalType="number",e=x.getNiceNumber(b-d,!1),this.interval=this._options&&this._options.interval?this._options.interval:x.getNiceNumber(e/(a-1),!0),this.minimum=null!==this.sessionVariables.internalMinimum?this.sessionVariables.internalMinimum:Math.floor(d/this.interval)*this.interval,this.maximum=null!==this.sessionVariables.internalMaximum?this.sessionVariables.internalMaximum:Math.ceil(b/
this.interval)*this.interval,"axisX"===this.type?(null===this.sessionVariables.internalMinimum&&(this.minimum=d-c/2),this.sessionVariables.internalMaximum||(this.maximum=b+c/2),this.intervalStartPosition=Math.floor((this.minimum+this.interval)/this.interval)*this.interval):"axisY"===this.type&&(this.intervalStartPosition=this.minimum));"axisX"===this.type&&(this._absoluteMinimum=this._options&&"undefined"!==typeof this._options.minimum?this._options.minimum:this.dataInfo.min-c/2,this._absoluteMaximum=
