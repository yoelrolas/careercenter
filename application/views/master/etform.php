<?php $this->load->view('header') ?>
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?=site_url('master/ets')?>"> Education Types</a></li>
                ...
                <div class="box box-primary" style="border-top-color: transparent">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="<?=COL_EDUCATIONTYPENAME?>" value="<?= $edit ? $data[COL_EDUCATIONTYPENAME] : ""?>" required>
                        </div>
                        <div class="form-group">
