...
foreach ($res as $d) {
    $res[$i] = array(
        '<input type="checkbox" class="cekbox" name="cekbox[]" value="' . $d[COL_LOCATIONID] . '" />',
        anchor('master/locationedit/'.$d[COL_LOCATIONID],$d[COL_LOCATIONNAME])
    );
    $i++;
}
...
?>
    ...
    <section class="content">
        <p>
            <?=anchor('master/locationdelete','<i class="fa fa-trash-o"></i> Hapus',array('class'=>'cekboxaction btn btn-danger','confirm'=>'Apa anda yakin?'))
            ?>
