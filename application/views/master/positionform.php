<?php $this->load->view('header') ?>
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?=site_url('master/positions')?>"> Positions</a></li>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="box box-primary" style="border-top-color: transparent">
                    <div class="box-body">
                        <?=form_open(current_url(),array('role'=>'form','id'=>'position'))?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="<?=COL_POSITIONNAME?>" value="<?= $edit ? $data[COL_POSITIONNAME] : ""?>" required>
                        </div>
                        <div class="form-group">
