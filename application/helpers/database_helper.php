...
define('TBL_PREFERENCETYPES','preferencetypes');
...
define('TBL_USERPREFERENCES','userpreferences');
define('TBL_USERS','users');
define('TBL_VACANCIES','vacancies');
define('TBL_VACANCYAPPLIES','vacancyapplies');
...
define('COL_PREFERENCETYPEID','PreferenceTypeID');
define('COL_PREFERENCETYPENAME','PreferenceTypeName');
...
define('COL_STATUSID','StatusID');
define('COL_STATUSNAME','StatusName');
...
define('COL_PREFERENCEVALUE','PreferenceValue');
...
define('COL_OTHERLOCATIONS','OtherLocations');
define('COL_ATTACHMENTFILENAME','AttachmentFileName');
define('COL_VACANCYAPPLYID','VacancyApplyID');
define('COL_APPLYDATE','ApplyDate');
